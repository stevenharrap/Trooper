namespace Trooper.Thorny.Configuration
{
    ...
    public class BusinessDynamicOperationService : IBusinessDynamicOperationService
    {
        public BusinessDynamicOperationService(Func<object> supporter, IBusinessDynamicHostInfo hostInfo)
        {
        ...
        public IBusinessDynamicHostInfo HostInfo { get; set; }
