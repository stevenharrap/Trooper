function BootstrapSearchBox(params) {
    ...
    GetBootstrapHtml().addControl(this.id, this, 'searchbox');
    $(document).ready($.proxy(this.init, this));
}

BootstrapSearchBox.prototype.id = '';

BootstrapSearchBox.prototype.formId = '';

BootstrapSearchBox.prototype.name = '';

BootstrapSearchBox.prototype.selectEvents = null;

BootstrapSearchBox.prototype.clearEvents = null;

BootstrapSearchBox.prototype.dataSourceUrl = null;

BootstrapSearchBox.prototype.searchTextField = null;

BootstrapSearchBox.prototype.searchValueField = null;

BootstrapSearchBox.prototype.selectedTextField = null;

BootstrapSearchBox.prototype.scrollHeight = 0;

BootstrapSearchBox.prototype.popoverPlacement = null;

BootstrapSearchBox.prototype.currentDataSelection = null;

BootstrapSearchBox.prototype.popoutWidth = null;

BootstrapSearchBox.prototype.currentAjaxRequest = null;

BootstrapSearchBox.prototype.getInputBox = function () {
    return $('#' + this.name + '_search');
};

BootstrapSearchBox.prototype.getHidden = function () {
    return $('#' + this.name);
};

BootstrapSearchBox.prototype.getContainer = function () {
    return this.getInputBox().parent();
};

BootstrapSearchBox.prototype.init = function () {
...
BootstrapSearchBox.prototype.insideClick = function (e) {
...
BootstrapSearchBox.prototype.outsideClick = function () {
    this.getInputBox().popover('destroy');
};


BootstrapSearchBox.prototype.clear = function() {
 ...
 */
BootstrapSearchBox.prototype.typing = function (key) {
...
BootstrapSearchBox.prototype.wait = function() {
    this.getInputBox().popover('destroy');
...
BootstrapSearchBox.prototype.done = function (result) {
    this.getInputBox().popover('destroy');
...
BootstrapSearchBox.prototype.showPopover = function () {
...
BootstrapSearchBox.prototype.selected = function (e) {
...
BootstrapSearchBox.prototype.fireClearEvent = function() {
    for (var i = 0; i < this.clearEvents.length; i++) {
        this.clearEvents[i]();
    }
};

BootstrapSearchBox.prototype.fail = function (error) {
